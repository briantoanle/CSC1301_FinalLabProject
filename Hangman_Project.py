...
# The picture representaion of the actual hangman itself
...
# Reads the text file and store words into list
...
# [[1,2,3],[3,4,5]]
# Returns word depending on difficulty picked
...
# Displays a introduction message and gets the dificulty picked from the user 
def gameRules():
...
# Used to make surethe guess made by the user is only a single letter
...
# Prints the picture of the hangman depending on the life the user is on and determines if the user needs a hint or not
...
# Contains and sets the entire game up
def setupGame():
    # set life to 0
    life = 0
    counter = 0
...
# Runs everything in the program in order to actually run the game
def playGame():
    while True:
        ...
        continue
#playGame()
print(len(masterListByLength[2]))